...
class Complaints extends Component {
  ...
  render() {
    ...
    if(complaints.length===0) {
      return(
      <div className="textz nothing-to-show" style={{marginTop : '20%'}} >  <center><img alt='image1' src="https://cdn.dribbble.com/users/45405/screenshots/2353058/gif-006-box.gif" height="300px" width="300px"/></center></div>
      )
    } else {
